...
public class DBConstants {
	...
	public static final String FIND_VEHICLE_REG_NUMBER = "select VEHICLE_REG_NUMBER from ticket where VEHICLE_REG_NUMBER =? group by VEHICLE_REG_NUMBER having count(VEHICLE_REG_NUMBER) > 0";
}
